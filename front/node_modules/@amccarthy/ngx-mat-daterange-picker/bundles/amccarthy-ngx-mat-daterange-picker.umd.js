(function (global, factory) {
	...
	typeof define === 'function' && define.amd ? define('@amccarthy/ngx-mat-daterange-picker', ['exports', '@angular/core', 'rxjs', '@angular/animations', '@angular/cdk/overlay', '@angular/cdk/portal', 'rxjs/operators', '@angular/common', '@angular/material/datepicker', '@angular/material/form-field', '@angular/material/core', '@angular/material/input', '@angular/material/button', '@angular/material/tooltip'], factory) :
	(factory((global.amccarthy = global.amccarthy || {}, global.amccarthy['ngx-mat-daterange-picker'] = {}),global.ng.core,global.rxjs,global.ng.animations,global.ng.cdk.overlay,global.ng.cdk.portal,global.Rx.Observable.prototype,global.ng.common,global.ng.material.datepicker,global.ng.material['form-field'],global.ng.material.core,global.ng.material.input,global.ng.material.button,global.ng.material.tooltip));
...
var NgxMatDrpComponent = /** @class */ (function () {
    ...
    NgxMatDrpComponent.prototype.ngOnInit = function () {
        ...
        this.rangeUpdate$ = this.rangeStoreService.rangeUpdate$.subscribe(function (range) {
            ...
            _this.selectedDateRange = (from === '' && to === '') ? '' : from + " - " + to;
...
var CalendarWrapperComponent = /** @class */ (function () {
    ...
    CalendarWrapperComponent.prototype.ngOnInit = function () {
    ...
    CalendarWrapperComponent.prototype.ngOnChanges = function (changes) {
        if (changes["selectedDate"].currentValue) {
            ...
            if (this.selectedTime) {
                var timeArr = this.timeStringToIntArray(this.selectedTime);
    ...
    CalendarWrapperComponent.prototype.onTimeChange = function ($event) {
        this.selectedTime = $event.target.value;
        this.selectedDateSetHours(this.selectedTime);
    };
    CalendarWrapperComponent.prototype.timeStringToIntArray = function (timeStr) {
    ...
    CalendarWrapperComponent.prototype.selectedDateSetHours = function (time) {
        var timeArr = this.timeStringToIntArray(time);
        this.selectedDate.setHours(timeArr[0], timeArr[1]);
    };
    ...
    CalendarWrapperComponent.prototype.clear = function () {
...
//# sourceMappingURL=amccarthy-ngx-mat-daterange-picker.umd.js.map
