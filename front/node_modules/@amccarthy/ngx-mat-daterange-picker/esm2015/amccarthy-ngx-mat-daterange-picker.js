...
class CalendarWrapperComponent {
    ...
    ngOnChanges(changes) {
        ...
        if (changes["selectedDate"].currentValue) {
            ...
            if (this.selectedTime) {
                /** @type {?} */
                let timeArr = this.timeStringToIntArray(this.selectedTime);
     ...
     * @return {?}
     */
    selectedDateSetHours(time) {
        /** @type {?} */
        let timeArr = this.timeStringToIntArray(time);
        this.selectedDate.setHours(timeArr[0], timeArr[1]);
    }
    /**
     * @param {?} e
